...
const Board = ({ game, setGame, setCanUndo, piece, username, locked, setLocked, sound }) => {
    ...
    return (
        <div className='my-5' >
            <div className='w-full text-[19px] text-center py-3  bg-[#FFE79E] dark:bg-[#ffda6b]'>
                <span className='dark:text-darkGray' >
            ...
            <div className='grid grid-cols-3 h-[334px]'>
                {
                    ...
                    p-5 bg-pri border-[#FFE79E] dark:border-[#ffda6b] flex justify-center itmes-center
